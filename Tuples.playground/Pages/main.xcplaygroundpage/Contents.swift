 ...
 */
var person = (name: "BillyJean", age: 30)
/*: question2
 ...
 */
let human = (name: "Joe", age: 20)
/*:
 ### 10. Can you change `human`'s age? Why or why not?
 */
// You can't change human's age because it is declared as a constant. In order tochange his age you have to change the constant declartion to variable
